...
_EXPECTED_INFORMATIONAL_ACTIONS = {
    "A01": ["EXPLAIN_A01_DIFFERENT_PART", "EXPLAIN_A01_MINIMUM_GUARANTEE_EXPIRED"],
    "B01": ["EXPLAIN_B01_ALREADY_REFUNDED", "EXPLAIN_B01_AUTHORIZED_OPERATION_OTHER_ROUTE"],
    "B02": ["EXPLAIN_B02_ALREADY_REFUNDED"],
    "B03": ["EXPLAIN_B03_ALREADY_REFUNDED", "EXPLAIN_B03_CHARGING_CONDITIONS_MET"],
    "R01": ["EXPLAIN_R01_ALREADY_REFUNDED", "EXPLAIN_R01_LEASE_NOT_ENDED"],
    "S01": ["EXPLAIN_S01_CLAIM_NOT_RECEIVED", "EXPLAIN_S01_MINIMUM_ALREADY_PAID"],
    "S02": ["EXPLAIN_S02_NONRENEWAL_NOT_SELECTED", "EXPLAIN_S02_NO_AUTOMATIC_RENEWAL"],
