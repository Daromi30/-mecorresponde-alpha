...
# Register vertical slices before routers bind service callables. Purchase
# extensions install first; electricity extensions wrap the already-extended
# shared Motor so there remains one runtime path for all families.
install_purchase_extensions()
from .electricity_extensions import install_electricity_extensions
install_electricity_extensions()
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "mecorresponde-alpha", "version": "0.5.0-alpha"}
