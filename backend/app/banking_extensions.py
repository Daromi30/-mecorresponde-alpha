...
def _b02_question(facts):
    ...
    order=[
      ...
      ("bank.direct_debit_article_48_2_confirmed","¿Consta que el adeudo domiciliado está dentro del régimen SEPA/Reglamento UE 260/2012 del artículo 48.2?","boolean"),
      ...
      ("bank.article_48_4_exception_status","Tras revisar contrato y aviso previo, ¿está claramente descartada la posible excepción del artículo 48.4?","choice:clearly_absent|possible_or_unknown"),
